	...
	virtual void ApplyImpulse() override
	{
...

		{
			float constraintMass = (m_pObj1->GetInverseMass() + m_pObj2->GetInverseMass())
								    + Vector3::Dot(abn, Vector3::Cross(m_pObj1->GetInverseInertia()
		...
		m_pObj1->SetAngularVelocity(m_pObj1->GetAngularVelocity() + m_pObj1->GetInverseInertia() *
									Vector3::Cross(r1, abn * jn));

		m_pObj2->SetAngularVelocity(m_pObj2->GetAngularVelocity() - m_pObj2->GetInverseInertia() *
